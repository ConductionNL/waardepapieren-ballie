...
class DefaultController extends AbstractController
{
    ...
    public function indexAction(CommonGroundService $commonGroundService, Request $request, ParameterBagInterface $params)
    {
        ...
        $variables['people'] = $commonGroundService->getResourceList(['component' => 'brp', 'type' => 'ingeschrevenpersonen'])['hydra:member'];
        ...
        if ($request->isMethod('POST')) {
            ...
            $variables['person'] = $commonGroundService->getResource($variables['certificate']['person']);
        }
